...
data_path_new="./data/NMRexp/${element}" # replace to your unlabeled data path
...
python ./uninmr/utils/get_result.py --path ${save_dir} --file_end "*valid.out.pkl" --mode cv --dict "./data/nmrshiftdb2_2024/All/dict.txt" 2>&1 | tee ${save_dir}/result.log
...
python ./uninmr/utils/get_result.py --path ${save_dir} --file_end "*valid.out.pkl" --mode cv --dict "./data/nmrshiftdb2_2024/All/dict.txt" 2>&1 | tee ${save_dir}/result_new.log
